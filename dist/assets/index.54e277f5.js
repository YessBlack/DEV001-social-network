...
async function So(t2, e, n) {
  const s = $$1(t2), i = s.Ui.get(e), r = n ? "readwrite" : "readwrite-primary";
  try {
...
async function cc(t2, e, n) {
  ...
  try {
    const t3 = await function(t4, e2) {
      const n2 = $$1(t4), s2 = nt.now(), i = e2.reduce((t5, e3) => t5.add(e3.key), fs());
      let r, o;
  ...
  const pageLogin = `<section class="containerAuth container">    
    <section class="containerAuth__content">
      ...
      <div class= "containerAuth__register-content">
        ...
        <a href="#recuperar" class="containerAuth__register-link" id="prueba">\xBFOlvidaste tu contrase\xF1a?</a>
      </div>
...
const eventsLogin = () => {
  ...
  $2("#prueba").addEventListener("click", () => {
...
const welcome = () => {
  ...
  <section class="container__content">
    <img src="https://firebasestorage.googleapis.com/v0/b/foodtrack-6348d.appspot.com/o/assets%2Flogo.svg?alt=media&token=9cda6baa-5ba7-441f-9ccf-b29ed42834b8" alt="logo" class="container__logo-content">
...
const addPost = (post) => pl(ea(db, "posts"), post);
const onGetPost = (callback) => Il(ea(db, "posts"), callback);
const deletePost = (id2) => yl(sa(db, "posts", id2));
const getPost = (id2) => al(sa(db, "posts", id2));
const updatePost = (id2, newFields) => gl(sa(db, "posts", id2), newFields);
...
const Post = (post, id2, idUserDB, imgProfile, name2, imgPost) => {
...
const eventsPerfil = () => {
  ...
  $2(".update-profile").addEventListener("click", (e) => {
    ...
    updateProfileUser(name2, currentUserInfo().photoURL);
